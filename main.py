...
#chrome_driver_binary = r"C:\Users\yyurc\.cache\selenium\chromedriver\win32\110.0.5481.77\chromedriver.exe"

#options.add_argument(r"C:\Users\yyurc\AppData\Local\Google\Chrome\User Data\System Profile\Network\Cookies") 
...
time.sleep(3)
# Находим поле ввода email и вводим логин

password_field = browser.find_element(By.CLASS_NAME, "google")
actions.move_to_element(password_field).click().perform()

time.sleep(10)

password_field = browser.find_element(By.CSS_SELECTOR, "input[type='email']")
for char in "yyurchikoff@gmail.com":
...
button_field = browser.find_element_by_xpath('//span[text()="Далее"]')
actions.move_to_element(button_field).click().perform()

time.sleep(8)

password_field = browser.find_element(By.CSS_SELECTOR, "input[type='password']")
for char in "dB0U7SKySTDazRKT":
    actions = actions.send_keys(char)
    actions.perform()
    time.sleep(random.uniform(0.1, 0.9))
